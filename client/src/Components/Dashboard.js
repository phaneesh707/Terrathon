                        ...
                        <TableBody>
                          {name.map((row) => (
                            <TableRow key={row.id}>
                              ...
                              <TableCell><button style={{borderRadius:"5px"}} value={row.name+"_"+row.aadhar} onClick={presBtn}>>></button></TableCell>
                              {/* <TableCell><ArrowForwardIcon value={row.name+"_"+row.aadhar} onClick={presBtn}/></TableCell> */}
